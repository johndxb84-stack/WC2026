...
describe('scoring and settlement', () => {
 ...
 it('a penalties bet counts as predicting ET even without ET score fields', () => expect(scorePrediction({homeScore:1,awayScore:1,homePenaltyScore:3,awayPenaltyScore:4},{...fixture,homeScore90:1,awayScore90:1,homeScoreExtraTime:2,awayScoreExtraTime:1}).reachedExtraTimePoints).toBe(1));
